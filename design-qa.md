...
- Browser captures: `refinement-dashboard.png`, `refinement-inventory.png`, `refinement-customer.png`
...
- Browser evidence: `design-qa-dashboard-final.png`, `design-qa-dealer-final.png`, `theme-light-dashboard.png`, and `theme-light-persisted.png`.
